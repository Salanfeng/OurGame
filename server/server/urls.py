...
urlpatterns = [
    ...
    re_path('searchComment', functions.searchComment, name = 'searchComment'),
    ...
    re_path('queryHighCommentGame', functions.queryHighCommentGame, name = 'queryHighCommentGame'),
    re_path('queryPublisherInf', functions.queryPublisherInf, name = 'queryPublisherInf'),
    re_path('attendActivity', functions.attendActivity, name = 'attendActivity'),
    re_path('acquireAchievement', functions.acquireAchievement, name = 'acquireAchievement'),
    re_path('joinCommunity', functions.joinCommunity, name = 'joinCommunity'),
